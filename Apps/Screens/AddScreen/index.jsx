...
export default function AddScreen() {
  ...
  const selectMediaFileRecord = async () => {
    try {
      let result = await ImagePicker.launchImageLibraryAsync({
        mediaTypes: ImagePicker.MediaTypeOptions.All,
        // allowsEditing: true,
      ...
      if (!result.canceled) {
        ...
        if (asset.type === "video") {
          ...
          setSelectedImage(asset.uri);
          setThumbnail(null);
          navigation.navigate("PreviewRecord", {
            media: asset.uri,
            thumbnail: null,
          });
        }
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.caption}>Selecciona tu foto o video</Text>
      <TouchableOpacity onPress={selectMediaFileRecord} style={styles.btn}>
        <View
          style={{
            display: "flex",
            flexDirection: "row",
        ...
        >
          <Text style={styles.btnText}>Para validad record</Text>
      ...
      <TouchableOpacity onPress={selectMediaFile} style={styles.btn}>
        ...
        >
          <Text style={styles.btnText}>Para Recuerdo Deportivo</Text>
